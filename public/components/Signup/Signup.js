...
export default function Signup() {
    ...
    const emailErrorDiv = container.querySelector('#emailError');
    const passwordErrorDiv = container.querySelector('#passwordError');
    const confirmErrorDiv = container.querySelector('#confirmError');
    ...
    const passwordInputs = [container.querySelector('#password'), container.querySelector('#confirm-password')];
