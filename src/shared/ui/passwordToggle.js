 ...
 */
export function setupPasswordToggle(parent) {
    const toggleButtons = parent.querySelectorAll('.toggle-password');
    const passwordInputs = [
        parent.querySelector('#password'),
        parent.querySelector('#confirm-password'),
    ];
